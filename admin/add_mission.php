      ...
      if ($cat != null) {
        ...
        if (count($_FILES) > 0) {
            if (is_uploaded_file($_FILES['Image']['tmp_name'])) {
                ...
                $sql = "INSERT INTO `mission-vission`(`title`,`description`,`image`) VALUES ('$title','$description','$imgData')";
                ...
                if ($current_id) {
                    ...
                    echo "<script>
                    setTimeout(function() {
                        window.location.replace('mission.php');
...
$select1 = "SELECT * FROM `mission-vission`";
...
<div class="modal fade" id="add_about_us" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content popup-form-modal" style="">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Add Mission & Vision</h4>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="insert" class="btn btn-success" style="font-weight:700;">Add Mision & Vision</button>
                </div>
            </form>
        </div>
    </div>
