  ...
  $description = simplename($_POST['description']);
        ...
        if (count($_FILES) > 0) {
            if (is_uploaded_file($_FILES['Image']['tmp_name'])) {
                ...
                $sql = "INSERT INTO `jag_legal_doc`(`title`,`images`,`description`) VALUES ('$title','$imgData','$description')";
        ...
        <div class="modal-content">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Add Business</h4>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="add" class="btn btn-success">Add Business</button>
                </div>
            </form>
        </div>
    </div>
