                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-sm-12">
                                            ...
                                            <input type="text" name="name" value="<?php echo $row['img_order']; ?>" class="form-control" id="exampleInputEmail1">
...
// print_r($_FILES);
    if (!empty($_FILES['img1']['tmp_name'])) {
        ...
        $update_img = "UPDATE `jag_slider` SET `image`='$images' , `img_order`='$name' WHERE `id`='$id'";        
        $result = mysqli_query($connection, $update_img);
    }
    else {
        // $images = addslashes(file_get_contents($_FILES['img1']['tmp_name']));
        $update_img = "UPDATE `jag_slider` SET `img_order`='$name' WHERE `id`='$id'";
        $result = mysqli_query($connection, $update_img);
    }
