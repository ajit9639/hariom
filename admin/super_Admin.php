...
<body style="background:url('bg4.jpg');background-size: cover;">
    <div class="row">
        <div class="col-md-6 mx-auto p-0 ">

            <div class="card" style="background-color: #89cdfc;">
                <div class="">
    ...
    border-radius:45px;
    ">
                            <img src="./dist/img/AdminLTELogo.png" style="width: 300px;margin: 0 auto;" />
                            </span>
                                ...
                                <form action="" method="POST">
                                    ...
                                    <div class="foot">
                                        <footer class="main-footer login-footer">
                                            <strong>Copyright &copy; <?php echo date('Y') ?> <a class="text-danger" href="#">Hari Om Casting Company Pvt Ltd.</a></strong>
                                            All rights reserved.
