      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1>Manage Office & Infrastructure</h1>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="#">Home</a></li>
                  <li class="breadcrumb-item active">office & infrastructure</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
              ...
              <div class="card">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">office & infrastructure</h3>
                  </div>
                  <!-- /.card-header -->
                  ...
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_legal" style="background:#e10d0d">Add New</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><a href="update_office.php?edit=<?php echo $rowimage['id']; ?>" class="btn btn-warning">Update</a>
