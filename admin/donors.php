...
{
  $img = "SELECT * FROM `jag_donors` WHERE 1";
              ...
              <div class="card">
                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">About Donors</h3>
                  </div>
                  <!-- /.card-header -->
                  ...
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_donor" style="background:#e10d0d">Add New Donor</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td> <a href="delete_donor.php?delete=<?php echo $rowimage['id']; ?>" class="btn btn-danger">Delete</a>
                            </tr>
                        <?php 
                        $cnt++;
                        }  ?>
