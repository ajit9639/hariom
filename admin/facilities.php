            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card">
                  ...
                  <!-- /.card-header -->
                  <?php include 'add_md_corner.php';
                        include 'update_legal.php';
                  // include 'update.php';
                  ?> 
               
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_chairman" style="background:#e10d0d">Add Facilities</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><a href="update_facilities.php?edit=<?php echo $rowimage['id']; ?>" class="btn btn-warning">Update</a>
