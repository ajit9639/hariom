...
{
  $img = "SELECT * FROM `covid-19` WHERE 1";
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card">
                  ...
                  <!-- /.card-header -->
                  <?php include 'add_covid-19.php';
                        include 'update_legal.php';
                  // include 'update.php';
                  ?> 
               
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_about_us" style="background:#e10d0d">Add Covid-19</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><a href="update_covid-19.php?edit=<?php echo $rowimage['id']; ?>" class="btn btn-warning">Update</a>
                              <td> <a href="delete-covid-19.php?delete=<?php echo $rowimage['id']; ?>" class="btn btn-danger">Delete</a>
                            </tr>
                        <?php 
                        $cnt++;
                        }  ?>
