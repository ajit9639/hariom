            ...
            if (is_uploaded_file($_FILES['Image']['tmp_name'])) {
                ...
                if ($current_id) {
                    ...
                    echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                      <strong>Success</strong> Gallery Image inserted successfully!!
        ...
        <div class="modal-content">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold" style="color: #f72000;">Add Gallery Image</h4>
                ...
                <div class="modal-body mx-10">
                 ...
                 <div class="form-group">
                        <label class="a-color" for="exampleFormControlSelect1">Enter Event Name</label>
                        <input name="event" type="text" class="form-control" id="event">

                    </div>
                    <div class="form-group">
                        <label class="a-color" for="exampleFormControlSelect1">Upload Gallery Image</label>
                        <input name="Image" type="file" class="form-control" id="exampleFormControlSelect1">

                    </div>
                    <div class="form-group">
                        <label class="a-color" for="exampleFormControlSelect1">Select Event Year</label>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="insert" class="btn btn-success">Add Gallery Image</button>
                </div>
            </form>
        </div>
    </div>
