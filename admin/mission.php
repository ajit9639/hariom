...
{
  $img = "SELECT * FROM `mission-vission` WHERE 1";
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card">
                  ...
                  <!-- /.card-header -->
                  <?php include 'add_mission.php';
                        include 'update_legal.php';
                  // include 'update.php';
                  ?> 
               
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#add_about_us" style="background:#e10d0d">Add New Mission & Vision</a>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td><a href="update_mission.php?edit=<?php echo $rowimage['id']; ?>" class="btn btn-warning">Update</a>
                              <td> <a href="delete_mission.php?delete=<?php echo $rowimage['id']; ?>" class="btn btn-danger">Delete</a>
                            </tr>
                        <?php 
                        $cnt++;
                        }  ?>
