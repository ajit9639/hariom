...
if (isset($_GET['edit']) && ($_GET['edit'] != '')) {
    ...
    $select_single_data = "SELECT * FROM `jag_slider` WHERE id=$id";
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-sm-12">
                                            <label for="exampleInputEmail1" class="form-label">Image Order</label>
                                            <input type="text" name="img_order" value="<?php echo $row['img_order']; ?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
...
if (isset($_POST['Submit'])) {
    ...
    if (!empty($_FILES['img1']['tmp_name'])) {
        ...
        $update_img = "UPDATE `jag_slider` SET `img_order`='$img_order',`image`='$images' WHERE `id`='$id'";
        $result = mysqli_query($connection, $update_img);
    }
    else {
        // $images = addslashes(file_get_contents($_FILES['img1']['tmp_name']));
        $update_img = "UPDATE `jag_slider` SET `img_order`='$img_order' WHERE `id`='$id'";
        $result = mysqli_query($connection, $update_img);
    }
