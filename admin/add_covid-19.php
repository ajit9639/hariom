      ...
      if ($cat != null) {
        ...
        if (count($_FILES) > 0) {
            if (is_uploaded_file($_FILES['Image']['tmp_name'])) {
                ...
                $sql = "INSERT INTO `covid-19`(`title`,`description`,`image`) VALUES ('$title','$description','$imgData')";
                ...
                if ($current_id) {
                    ...
                    echo "<script>
                    setTimeout(function() {
                        window.location.replace('covid-19.php');
        ...
        <div class="modal-content popup-form-modal" style="">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">Add Covid-19</h4>
                ...
                <div class="modal-footer d-flex justify-content-center">
                    <button name="insert" class="btn btn-success" style="font-weight:700;">Add Covid-19</button>
                </div>
            </form>
        </div>
    </div>
