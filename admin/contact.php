...
if (isset($_SESSION['username']) && ($_SESSION['username'] != '')) {
  $select = "SELECT * FROM `jag_contact` WHERE 1";
                    ...
                    <tbody>
                      ...
                      <!-- massage end -->
                          <tr>
                            ...
                            <td><?php echo $rows['con_query']; ?></td>
                            


                            <td> <a href="delete_contact.php?delete=<?php echo $rows['con_id']; ?>" class="btn btn-danger">Delete</a>
