                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="top-bar-item">
                                ...
                                <div class="top-bar-text">
                                    <h3>Address</h3>
                                    <p>743-A, Large Sector, Industrial Area
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="about-directors.php" class="dropdown-item">About Directors</a>
                    ...
                    <div class="ml-auto">
                        <a class="btn btn-custom" href="contact.php">Feel Free to Contact us</a>
                    </div>
                </div>
            </nav>
        </div>
